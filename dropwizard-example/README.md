...
* To setup the h2 database run.
        ...
        Example: --> java -jar target/dropwizard-example-2.0.2-SNAPSHOT.jar db migrate example.yml
        
* To run the server run.

        java -jar target/dropwizard-example-$DW_VERSION.jar server example.yml
        Example: -->  java -jar target/dropwizard-example-2.0.2-SNAPSHOT.jar server example.yml
